      ...
      <section className="mx-auto mt-8 grid w-full grid-cols-1 gap-4 px-16 md:grid-cols-3">
        {[
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-0 rounded-lg bg-gradient-to-r from-green-200 to-green-600 opacity-0 transition-opacity duration-300 hover:opacity-100"></div>
          </Button>
        ))}
      </section>
    </div>
